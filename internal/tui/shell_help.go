...
var helpEntries = []helpEntry{
	...
	{"🔧", "settings backend set", "<auto|cmux|ghostty>", func(b client.DetectedBackend) string { return "Set default backend" }, "Settings"},
	{"🔍", "settings backend get", "", func(b client.DetectedBackend) string { return "Show default backend" }, "Settings"},
	{"📋", "settings backend list", "", func(b client.DetectedBackend) string { return "List available backends" }, "Settings"},
