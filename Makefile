...
LDFLAGS := -ldflags "-s -w -X github.com/juanatsap/cmux-resurrect/cmd.Version=$(VERSION) -X github.com/juanatsap/cmux-resurrect/cmd.Commit=$(COMMIT) -X github.com/juanatsap/cmux-resurrect/cmd.Date=$(DATE)"
